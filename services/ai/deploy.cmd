@echo off
REM ZipCheck AI - Cloud Run 배포 스크립트 (Windows)
REM 필수 환경변수 14개 포함
...
REM 프로젝트 루트로 이동
cd /d c:\dev\zipcheckv2

REM 배포 실행 (CORS는 세미콜론으로 구분)
gcloud run deploy zipcheck-ai ^
  --source services/ai ^
  --region asia-northeast3 ^
  --allow-unauthenticated ^
  --project advance-vector-475706-a5 ^
  --update-env-vars "APP_ENV=production,LOG_LEVEL=INFO,SUPABASE_URL=https://gsiismzchtgdklvdvggu.supabase.co,AI_ALLOWED_ORIGINS=https://zipcheck.kr;https://www.zipcheck.kr;http://localhost:3000" ^
